...
This __init__.py makes `apps.products.views` module work
even though views/ is a folder (for future sub-view files).
"""
...
def category_products(request, slug):
    ...
    get_object_or_404(Category, slug=slug, is_active=True)
...
def brand_products(request, slug):
    ...
    get_object_or_404(Brand, slug=slug, is_active=True)
    request.GET = request.GET.copy()
